...
class MaskCNN_MOTS(object):
    def run(self, argv):
        ...
        for iter in data_it:
            print('iteration {}'.format(iterations[0][0]))
            print('lr {}'.format(iterations[0][1]))
            ...
            cfg.SOLVER.IMS_PER_BATCH = iterations[0][2]
            cfg.SOLVER.BASE_LR = iterations[0][1]
            cfg.SOLVER.LR_SCHEDULER_NAME = iterations[0][3]
            cfg.MODEL.RPN.PRE_NMS_TOPK_TRAIN = iterations[0][4]
