...
for d in ["train", "val"]:
    DatasetCatalog.register("fcnn-kittimots" + d, lambda d=d: get_KITTIMOTS_dicts(d))
...
cfg.DATASETS.TEST = ("fcnn-kittimotsval", )


evaluator = COCOEvaluator("fcnn-kittimotsval", cfg, False, output_dir="./output/")
